...
def get_city():
    '''
    This function takes input from user the name of 0a city and returns the filename for that city's bike share data.
    Returns:
    Type - Str. Filename for a city's bikeshare data.
    '''
    city = ''
    while city.lower() not in ['chicago', 'new york', 'washington']:
        ...
        if city.lower() == 'chicago':
            ...
            print('Sorry, I do not understand the input provided. Please input either '
                  'Chicago, New York, or Washington.')

def get_time_period():
    '''
    This function takes input from user the time period and returns the specified filterd value.
    Returns:
    Type - Str. Filter time for the bikeshare data.
    '''
    time_period = ''
    while time_period.lower() not in ['month', 'day', 'none']:
        ...
        if time_period.lower() not in ['month', 'day', 'none']:
            print('Sorry, I do not understand the input provided.')
    return time_period

def get_month():
    '''
    This function takes input from user the month and returns the specified month.
    Returns:
    Type - Tuple. Lower limit, upper limit of month for the bikeshare data.
    '''
    month_input = ''
    ...
    while month_input.lower() not in months_dict.keys():
        ...
        if month_input.lower() not in months_dict.keys():
            print('Sorry, I do not understand the input provided. Please type '
...
def get_day():
    '''
    This function takes input from user the day and returns the specified day.
    Returns:
    Type - Tuple. Lower limit, upper limit of date for the bikeshare data.
    '''
    ...
    while valid_date == False:
        is_int = False
        day = input('\nEnter a day of the month? Please type the response as an integer.\n')
        while is_int == False:
            try:
                day = int(day)
                is_int = True
            except ValueError:
                print('Sorry, I do not understand the input provided. Please type the'
...
def popular_month(df):
    '''
    This function seacrhes for most popular month for start time and prints it.
    Arguments :
    dataframe
    Returns:
    None
...
def popular_day(df):
    '''
    This function searches for most popular day of the week for start time and prints it.
    Arguments:
    dataframe
    Returns:
    None
...
def popular_hour(df):
    '''
    This function searches for the most popular hour of the day for start time and prints it.
    Arguments:
    dataframe
    Returns:
    None
...
def trip_duration(df):
    '''
    This function searches for the total trip duration and average trip duration in hours, minutes, and seconds and prints it.
    Arguments:
    dataframe
    Returns:
    None
...
def popular_stations(df):
    '''
    This function searched for most popular start station and most popular end station and prints it.
    Arguments:
    dataframe
    Returns:
    None
...
def popular_trip(df):
    '''
    This function searches for the most popular trip and prints it.
    Arguments:
    dataframe
    Returns:
    None
...
def users(df):
    '''
    This fucntion searches for the count of each user type and prints it.
    Arguments:
    dataframe
    Returns:
    None
...
def gender(df):
    '''
    This fucntion searched for the count of gender and prints it.
    Arguments:
    dataframe
    Returns:
    None
...
def birth_years(df):
    '''
    This function searched for the earliest (i.e. oldest user), most recent (i.e.
        youngest user), and most popular birth years and prints it.
    Arguments:
    dataframe
    Returns:
    None
...
def display_data(df):
    '''
    This fucntion shows the five lines of data if the user specifies that they would like to.
    After showing the five lines, it prompts the user if they would like to see five more data,
    continues to prompts until they want to stop.
    Arguments:
    data frame
    Returns:
    None
    ...
    while valid_input == False:
        ...
        if valid_input == True:
            ...
            print("Sorry, I do not understand the input provided. Please type 'yes' or"
                  " 'no'.")
...
def statistics():
    '''
    This fucntion calculates and prints out the descriptive statistics data about a city and
